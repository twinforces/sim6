...
Why: User asked for every card, then hygiene so he can grab it in the morning.
...
- CHANGELOG still has the pre-book LTCM and Benihana entries. Leave them. The later "not memory" entries are the correction.
