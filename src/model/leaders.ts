...
const LEADERS: Record<LeaderId, Leader> = {
  ...
  cayne: {
    ...
    name: "Jimmy Cayne",
    role: "Bear Stearns. In 1998 this bank would not put money into the Long-Term Capital rescue. The rhyme is the point.",
  ...
  fastow: {
    ...
    name: "Andrew Fastow",
    role: "Chief financial officer. He built the vehicles that hide the losses. You are the letterhead.",
  ...
  clinton: {
    ...
    name: "Bill Clinton",
    role: "President of the United States. The Long-Term Capital weekend will be sold as proof that complexity is safe.",
